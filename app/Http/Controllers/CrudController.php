...
class CrudController extends Controller
{
  ...
  */
  public function index()
  {
    ...
    $employees = app('firebase.firestore')->database()->collection('Employee')->documents();
  ...
  public function view()
  {
    ...
    $employee = app('firebase.firestore')->database()->collection('Employee')->document('4kn3oiTJyv2f9oQYuKJq')->collection('Record')->documents();
