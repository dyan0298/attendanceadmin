...
Route::get('/display', function(){
  $student = app('firebase.firestore')->database()->collection('Employee')->document('166f34ea1c9641dab0a0')->snapshot();
...
Route::resource('/user', App\Http\Controllers\ViewController::class);
